...
import 'package:kotlinproject/global/customwidget/slide_dots.dart';
import 'package:kotlinproject/global/customwidget/slide_item.dart';
          ...
          child: Row(
            ...
            children: <Widget>[
              FlatButton(
                ...
                onPressed: () {
                  navigationPush(context, FcmSocialLogin());
                },
              ),
              FlatButton(
                child: Text(
